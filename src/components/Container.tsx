...
function Container({ children } : ReactNodeProps) {
  ...
  return (
    <main className=" bg-neutral-900 h-fit md:pl-4 md:pr-4 pl-2 pr-2 pb-6  pt-20">
        ...
        loading? 
        <>
        <svg className="inline w-10 h-10 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
